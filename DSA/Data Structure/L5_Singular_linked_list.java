...
class Node{
    public int value; // as we want the value to be a integer.
    public Node next; // here "Node" is the datatype, which is the class Node.
}
...
public class L5_Singular_linked_list {
    public static void main(String[] args) {
        SingularLinkedList sl = new SingularLinkedList();
        sl.createSingularLinkedList(5);
        // System.out.println(sl.head.value);
        sl.insertInLinkedlist(7,1);
        sl.insertInLinkedlist(8,2);
        sl.insertInLinkedlist(9,3);

        sl.traversalLinkedList();
        // sl.searchNode(81);
        // sl.deletionOfNode(2);
